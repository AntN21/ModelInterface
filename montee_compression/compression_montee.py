...
def simulate_once(netlogo, number_out, prop_personnes_polies, patience_gens_polis, max_ticks, seed):
    """
    ...
    netlogo.command(f'set prop_personnes_polies {prop_personnes_polies}')
    netlogo.command(f'set patience_gens_polis {patience_gens_polis}')
